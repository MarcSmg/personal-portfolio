...
const DEFAULT_GLOW_COLOR = '71, 140, 251';
...
const ParticleCard: React.FC<{
  ...
  return (
    <div ref={cardRef} className={`magic-bento-card relative h-full w-full overflow-hidden rounded-2xl ${className}`}>
...
const MagicBento: React.FC<MagicBentoProps> = ({
  ...
  return (
    <>
      <style>
        {`
          ...
          .magic-bento-card--border-glow:hover {
            box-shadow: 0 4px 20px rgba(${glowColor}, 0.18), 0 0 30px rgba(${glowColor}, 0.16);
          }
      ...
      <div ref={gridRef} className={`magic-bento-section grid ${className}`}>
